...
/**
  ...
  * result.
  */
class WebFetcherActionBuilder @Inject()(messagesApi: MessagesApi,
...
/**
  ...
  */
case class WebFetcherControllerComponents @Inject()(
    postActionBuilder: WebFetcherActionBuilder,
    postResourceHandler: WebFetcherResourceHandler,
...
/**
  ...
  */
class WebFetcherBaseController @Inject()(pcc: WebFetcherControllerComponents)
    extends BaseController
    with RequestMarkerContext {
  override protected def controllerComponents: ControllerComponents = pcc

  def PostAction: WebFetcherActionBuilder = pcc.postActionBuilder

  def postResourceHandler: WebFetcherResourceHandler = pcc.postResourceHandler
}
